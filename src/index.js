...
function runBot(chartPage, brokerPage){
    ...
    var botInterval = setInterval(async () => {
      ...
      if(curSec == 59){
        ...
        let [buyOrSell_Signal] = await page.$x('/html/body/div[2]/div[1]/div[2]/div[1]/div/table/tr[1]/td[2]/div/div[1]/div[2]/div[2]/div[2]/div[2]/div/div[10]/div');
        let buyOrSell = 
          String(await page.evaluate(name => name.innerText, buyOrSell_Signal)).length; //buy or sell 1.00 = buy, -1.00 = sell; Buy: 4, Sell: 5;
        let [atr_take_profit_1x] = await page.$x('/html/body/div[2]/div[1]/div[2]/div[1]/div/table/tr[1]/td[2]/div/div[1]/div[2]/div[2]/div[2]/div[2]/div/div[5]/div');
        let atr_1x = parseFloat(await page.evaluate(name => name.innerText, atr_take_profit_1x));
        let [atr_take_profit_1dot5x] = await page.$x('/html/body/div[2]/div[1]/div[2]/div[1]/div/table/tr[1]/td[2]/div/div[1]/div[2]/div[2]/div[2]/div[2]/div/div[7]/div');
        let atr_1dot5x = parseFloat(await page.evaluate(name => name.innerText, atr_take_profit_1dot5x));
        let [atr_take_profit_2x] = await page.$x('/html/body/div[2]/div[1]/div[2]/div[1]/div/table/tr[1]/td[2]/div/div[1]/div[2]/div[2]/div[2]/div[2]/div/div[16]/div');
        let atr_2x = parseFloat(await page.evaluate(name => name.innerText, atr_take_profit_2x));
        let [closing_price] = await page.$x('/html/body/div[2]/div[1]/div[2]/div[1]/div/table/tr[1]/td[2]/div/div[1]/div[1]/div[1]/div[2]/div/div[5]/div[2]'); //closing price
        let price = parseFloat(await page.evaluate(name => name.innerText, closing_price));
        let [dynamic_overbought] = await page.$x('/html/body/div[2]/div[1]/div[2]/div[1]/div/table/tr[3]/td[2]/div/div[1]/div/div[2]/div[2]/div[2]/div/div[5]/div');
        let dynamicOverboughtValue = parseFloat(await page.evaluate(name => name.innerText, dynamic_overbought));
        let [crsi] = await page.$x('/html/body/div[2]/div[1]/div[2]/div[1]/div/table/tr[3]/td[2]/div/div[1]/div/div[2]/div[2]/div[2]/div/div[7]/div');
        let CRSIValue = parseFloat(await page.evaluate(name => name.innerText, crsi));
        let [riskATR_Top] = await page.$x('/html/body/div[2]/div[1]/div[2]/div[1]/div/table/tr[1]/td[2]/div/div[1]/div[2]/div[2]/div[2]/div[2]/div/div[2]/div');
        let riskATR_Top_Value = parseFloat(await page.evaluate(name => name.innerText, riskATR_Top));
        let [riskATR_Bottom] = await page.$x('/html/body/div[2]/div[1]/div[2]/div[1]/div/table/tr[1]/td[2]/div/div[1]/div[2]/div[2]/div[2]/div[2]/div/div[3]/div');
        let riskATR_Bottom_Value = parseFloat(await page.evaluate(name => name.innerText, riskATR_Bottom));
        let static_overbought = 70;
